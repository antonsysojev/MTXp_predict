### THIS SCRIPT IS CLONED AND MODIFIED FROM THE GITHUB OF THE AUTHOR OF `betacal`
### SEE THIS PAGE: https://github.com/betacal/R/blob/master/tutorial/fit.isoreg.r FOR ORIGINAL
